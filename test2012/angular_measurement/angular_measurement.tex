...
simulation where the rates have been normalized to 1~s of beam at a current of 90~nA. 
\begin{figure*}[t]
...
\end{figure*}
The total rate prediction for simulation and data are compared in Fig.~\ref{fig:rate_vs_thickness} 
