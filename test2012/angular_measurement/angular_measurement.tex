...
{\bf {\color{red} It's not clear if the detailed description of what calculation is used where for egs5 vs Geant4. I should probably add details on the pair angle calculations here and refer the MCS to newt section?} }

These measured angular distributions was compared to simulation. 
...
the prediction from {\sc EGS5} and {\sc Geant4} multiple scattering models.} {\color{red} Obviously need update.}}
\label{fig:ang_distr_data}
\end{figure*}
