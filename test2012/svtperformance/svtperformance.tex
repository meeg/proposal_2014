...
The time reconstruction algorithm described in Sec.~\ref{sec:svt} was used to fit a single hit to each SVT channel in each event. The fit quality $\chi^2$ was shown to agree with the expected distribution 
...
amplitude-weighted average of the hit times for each channel that belong to that cluster. Since we have no measurement of the ``true'' hit time, we study the overall SVT hit 
...
\input{test2012/svtperformance/daq/svt_daq.tex}
