...
by masking out all known noisy channels found during the comissioning of the 
...
\begin{table}[h]
    ...
    \caption{Comparison of cccupancy, event size and resulting data rate for each of the three 
