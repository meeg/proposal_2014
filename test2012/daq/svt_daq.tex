...
power distribution system inside the vacuum described in Sec.~\ref{sec:svt_daq}.  The test run had a total of 20 silicon strip sensors, each one connected to an onboard hybrid readout card 
which is similar to the HPS hybrid, each one holding five 128-channel APV25 integrated circuits, 
see Fig.~\ref{fig:hybrid_and_apv25_testrun} 
 \begin{figure*}[t]
\includegraphics[ scale=0.3]{test2012/daq/hybrid.jpg}
\includegraphics[ scale=0.3]{test2012/daq/apvs-on-hybrid.jpg}
\caption{\small{Test run hybrid readout board with five APV25 ASICs showing the encapsulated wire bonds 
between the ASICs and the silicon sensor.}}
\label{fig:hybrid_and_apv25_testrun}
\end{figure*}
Contrary to the HPS DAQ where front end boards digitize the APV25 analog output signals 
