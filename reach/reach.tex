...
\caption{Right: Distribution of statistics in full resonance search.
  ...
  resolution-limited mass window of width $\delta m_(A' )=2.5 \sigma (m_{A'})$.  The blue 
curves correspond to the distributions of statistics for a one month run at 6.6 GeV 
beam energy, with a current of 450 nA on a 0.25\% $X_0$ target, while the red
curves correspond to six weeks  at 2.2 GeV beam energy and a 0.125\% $X_0$ target.}
...
\caption{In blue:  the value of the minimum vertex displacement $zcut$ (in mm) along the beamline, required for 
