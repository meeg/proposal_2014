...
or pair production. While the X-ray production is not simulated in EGS5, the X-ray intensity at SVT layer 1
...
the target. The intensities of these EM induced backgrounds are small and no interference with the SVT is expected. he beam charge per 2ns CEBAF bunch is only ~few thousand electrons, many orders of magnitude lower than that in other experiments which have chosen to shield against it.
