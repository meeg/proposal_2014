...
HPS employs two data acquisition (DAQ) architectures: the SVT is readout with 
...
For the SVT ATCA system, the ROC runs on 
a processor blade in the ATCA crate. 
...
hybrid board incorporating five 128-channel APV125 front-end 
ASICs~\ref{Jones:1069892,Raymond:2002yr}, see Fig.~\ref{fig:hybrid_and_apv25_testrun}.
The APV25 ASIC, initially developed for the Compact Muon Solenoid silicon tracker  at the Large Hadron 
Collider at CERN, was chosen because it provides excellent signal to noise, analogue output for optimal 
...
conversion and to transmit the optical signals over 10~m fibers to the SVT DAQ. 
...
The main characteristics of the Jefferson Lab Flash ADC are:
\begin{itemize}
...
the rate is 43MB/s, well within the SVT DAQ capabilities. 
The ECal and muon detectors, with occupancies between 3-10\%, each contribute with an event size of 
approximately 0.3kB and maximum rates of about 12~MB/s for the 1.1~GeV run. 
