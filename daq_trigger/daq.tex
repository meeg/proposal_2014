...
HPS DAQ to re-use architecture and functionality from other DAQ systems such as the ATLAS muon 
system whose components are similar to that used by HPS. Figure~\ref{fig:rtm_testrun} shows the boards designed and used for the HPS Test run.
...
Three 20-slot VXS crates are needed to accommodate the system: one for each half of the ECal with 221 channels and one for the muon detector with a total of 232 channels.
...
\hline
Total& \multicolumn{3}{|c|}{-} & 3.0 & 2.2 & 2.0 & 51.9 & 25.4 & 25.6 \\
\hline
\end{tabular}
