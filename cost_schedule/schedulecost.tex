...
and M\&S being respectively 53\% and 7.65\% at SLAC, 57.15\% and 49\% at JLAB. SLAC travel includes 53\% overheads. A uniform cost 
contingency of 20\% has been applied. Since the project is staged over three years, an annual inflation rate of 2.5\%  is included in 
...
Frascati magnet, and a photon dump and shielding inserted behind the second chicane magnet. Total beamline expenses are about \$280k.
...
RCE cards are also required. The expenses are dominated by engineering development, and total \$530k.  
...
roughly \$260k, including fabrication, assembly, and testing. Trigger and DAQ electronics for the ECAL are being developed for 
...
vacuum chamber, and building support stands and providing cables.The total is \$370k. 
...
movements of the SVT with respect the beamline and provide beam protection interlocks. The total cost is \$200K, which is essentially 
the labor 
...
Funds are also reserved  to staff installation, commissioning, and data taking runs. The total is \$190K.

{\bf The total cost for HPS is \$2.64 M. }

HPS is seeking funding from other sources for the Muon System and the Ecal.
William\&Mary will submit an MRI proposal to NSF for the Muon System, requesting $\sim \$130$k. IPN ORSAY (France) 
...
in the collaboration will help in assembly and test of the ECal, especially groups from Norfolk State University 
(Carlos Salgado), and INFN Genova(Italy). 
...
\centering
%\vspace*{-5mm}
\includegraphics[angle=90,width=0.5\textwidth]{cost_schedule/cost_systems_table.jpg} 
...
\includepdf[pages=1-11,angle=90,scale=0.8]{cost_schedule/HPSV70p.pdf}
