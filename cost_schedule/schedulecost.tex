...
\rotatebox{90}{
\begin{tabular}{l|p{1.4 in}|c|c|c|>{\centering\arraybackslash}p{0.6 in}|>{\centering\arraybackslash}p{0.65 in}|>{\centering\arraybackslash}p{0.65 in}|c|c|c|c|>{\centering\arraybackslash}p{0.6 in}}
WBS	&Task Name	&Labor	&Material	&Total	&Labor w/Cont.	&Material w/Cont.	&Total w/Cont.	&Spares	&Proto.	&Ops	&Infra.	&Capital Eq.\\
\hline\hline
...
1.1	&Beamline	&\\
\hline
1.1.2	&\hspace{2 pt}End of Beamline Design	&20-Dec-13\\
\hline
1.1.13	&\hspace{2 pt}Beamline Installed	&26-Sep-14\\
\hline
1.2	&SVT	&\\
\hline
1.2.3	&\hspace{2 pt}Layer 1-3 Ready	&17-Feb-14\\
\hline
1.2.5	&\hspace{2 pt}Layer 4-6 Ready	&18-Apr-14\\
\hline
1.2.14	&\hspace{2 pt}SVT tested and ready for shipment	&9-Jun-14\\
\hline
1.2.16	&\hspace{2 pt}SVT Ready For Installation	&15-Aug-14\\
\hline
1.3	&SVT DAQ	&\\
\hline
1.3.12	&\hspace{2 pt}FE Board Tested w/ hybrid	&5-Aug-13\\
\hline
1.3.15	&\hspace{2 pt}Flange DAQ Tested	&10-Jan-14\\
\hline
1.3.14	&\hspace{2 pt}DAQ Full system Test	&2-Jun-14\\
\hline
1.3.4.9	&\hspace{2 pt}Single Hybrid qualification	&20-Jun-13\\
\hline
1.3.13	&\hspace{2 pt}Flex Cable w/ hybrid \& FE board	&10-Jan-14\\
\hline
1.4	& ECAL	&\\
\hline
1.4.8	&\hspace{2 pt}ECAL Ready for the installation	&1-Aug-14\\
\hline
1.5	&TDAQ	&\\
\hline
1.5.9	&\hspace{2 pt}TDAQ Ready	&6-Dec-13\\
\hline
1.7	&Installation \& Commissioning	&4-Aug-14\\
\hline
1.7.5	&\hspace{2 pt}HPS ready for the beam	&1-Sep-14\\
\hline
\hline
\end{tabular}
\end{center}
