...
\end{tabular}
\end{center}
\label{Distribution of resources}
\end{table}%
...
\end{tabular}
\end{center}
\label{Total Engineering Labor (hrs) required for three years. Only SLAC and JLAB charge costs.}
\end{table}%

\begin{figure*}[h]
\centering
%\vspace*{-5mm}
\includegraphics[width=0.7\textwidth]{cost_schedule/cost_systems.jpg} 
...
\centering
%\vspace*{-5mm}
\includegraphics[width=0.7\textwidth]{cost_schedule/spending.jpg} 
...
\centering
%\vspace*{-5mm}
\includegraphics[width=\textwidth]{cost_schedule/schedule-1.jpg} 
\caption{HPS schedule, part-I.}
\label{fig:sch1}
\end{figure*}
...
\centering
%\vspace*{-5mm}
\includegraphics[width=\textwidth]{cost_schedule/schedule-2.jpg} 
\caption{HPS schedule, part-II.}
\label{fig:sch2}
\end{figure*}
