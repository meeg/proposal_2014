...
\rotatebox{90}{
\begin{tabular}{l|>{\centering\arraybackslash}p{1.4 in}|c|c|c|>{\centering\arraybackslash}p{0.6 in}|>{\centering\arraybackslash}p{0.65 in}|>{\centering\arraybackslash}p{0.65 in}|c|c|c|c|>{\centering\arraybackslash}p{0.6 in}}
