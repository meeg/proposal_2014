...
\rotatebox{90}{
\begin{tabular}{l|p{1.4 in}|r|r|r|>{\raggedleft\arraybackslash}p{0.6 in}|>{\raggedleft\arraybackslash}p{0.65 in}|>{\raggedleft\arraybackslash}p{0.65 in}|r|r|r|r|>{\raggedleft\arraybackslash}p{0.6 in}}
