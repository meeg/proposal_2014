...
allow $A'$s to resolve several anomalies (see below). Existing constraints~\cite{endo:g2e} are 
shown in Fig.~\ref{fig:hspaw-heavy-A'}. HPS will be sensitive to $A'$ masses in between 20--1000~MeV.
...
HPS is primarily designed to look for new sub-GeV $A'$s that decay into lepton pairs.
