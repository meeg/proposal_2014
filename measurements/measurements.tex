...
Jefferson Labs PAC39 graded HPS physics with an "A", approved a commissioning run for requested 3 weeks with electrons, and granted so-called �C1� approval for the full HPS experiment for $180$ days of beam time at multiple beam energies. HPS plans to execute the full experiment in two phases. The first phase, expected to run in 2014-2015, will consume the full beam time for the test and commissioning, and the 1/3 of the production running time at $2.2$ GeV and $6.6$ GeV beam energies. The second phase that will use remaining beam time can be completed any time after that.  
...
Accounting for all the efficiencies associated with a separated vertex search, we would expect to see about 20--30 true muonium events in 2 weeks of $6.6$ GeV run
