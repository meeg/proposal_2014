...
below.   
%More details of $\ap$ production and decay are given in Appendix \ref{app:ProdAndDecay}.
...
\caption{ Left: The distribution of Bethe-Heitler background events (black) and $A^\prime$ signal events (red) as a function of the sum of the electron and positron energy. Note that the $A^\prime$ events  are peaked at high energies, while the Bethe-Heitler background is peaked at much lower energies. Right: The distribution of the positron versus electron energy for Bethe-Heitler  events (black dots) and $A^\prime$ events (red dots). Note that in both plots the $A^\prime$ and Bethe-Heitler events  are normalized to the same number. In reality, the number of Bethe-Heitler  events is orders of magnitude larger (prior to kinematic cuts) than the number of $A^\prime$ events for couplings that
HPS is sensitive to. Even after making a reasonable kinematic cut, the rate of Bethe-Heitler events is much larger than the $A^\prime$ rate.  Also, note that the electron energy here refers to the energy of the electron produced in the reaction, not the recoiling beam electron.}
